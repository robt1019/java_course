...
class DB{
	...
	public void run(){
		...
		Record testRecord = new Record(5, "Gromit");
		...
		Record testRecord1 = new Record(5, "Nobber");
		Record testRecord2 = new Record(5, "Nobber");
		...
		String testRecord1Field = testRecord1.getField(2).getName();
		System.out.println(testRecord1Field);
